...
export default {
    ...
    components: {
        ...
        'dialog-due-date': require('@/components/Todo/Dialog/DialogDueDate.vue').default,
        'dialog-delete': require('@/components/Todo/Dialog/DialogDelete.vue').default,
    }
};
</script>
